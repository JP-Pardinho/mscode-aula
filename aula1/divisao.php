...
<body>
    <header>
        <nav class="navbar bg-success fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Calculadora do Pardin</a>
    ...
    <main class="mb-5 text-center">
        <section>
            <img src="imagens/divisao.png" class="d-block w-100" alt="imagem divisao">
        </section>

        <section class="container">
            <h1 class="mt-5">Tabuada da divisão</h1>
            <p>Digite um número para ver a tabuada da divisão com ele.</p>
        </section>
            ...
            <div>
                ...
                if ('' === $mensagemErro && null !== $tabuada && 0 !== $tabuada) {
                    for ($j = 1; $j <= $valorMaximoTabuada; $j++) {
                        $resultado = ($j * $tabuada) / $tabuada;
    
                        echo sprintf('<span>%d / %d = %d</span> </br>', ($j * $tabuada), $tabuada, $resultado);
                    }
                }
